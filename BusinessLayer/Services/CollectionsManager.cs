...
namespace BusinessLayer.Services
{
    public class CollectionsManager : ICollectionsManager
    {
        ...
        private readonly IUpdateCollectionModelValidator updateCollectionModelValidator;

        private readonly IMapper mapper;

        public CollectionsManager(ICollectionsCrudService collectionsCrudService, IThemesCrudService themesCrudService,
            IUserCrudService userCrudService, IResourceCrudService resourceCrudService, IUpdateCollectionModelValidator updateCollectionModelValidator , IMapper mapper)
        {
            this.mapper = mapper;
        ...
        {
            var result = await updateCollectionModelValidator.ValidateAsync(updateCollectionModel);
            if (!result.Succeed)
                return result;
        ...
        //{
        //    var result = new CreateCollectionResult();
        //    var authenticated = await modelAuthenticator.Authenticate(createCollectionModel);
        //    if (!authenticated)
        //    {
